...
WrapperTypeInfo V8HTMLMapElement::info = { V8HTMLMapElement::GetTemplate, V8HTMLMapElement::derefObject, 0, &V8HTMLElement::info };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLMapElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "HTMLMapElement", V8HTMLElement::GetTemplate(), V8HTMLMapElement::internalFieldCount,
        HTMLMapElementAttrs, WTF_ARRAY_LENGTH(HTMLMapElementAttrs),
        0, 0);
...
v8::Handle<v8::Object> V8HTMLMapElement::wrapSlow(HTMLMapElement* impl)
{
