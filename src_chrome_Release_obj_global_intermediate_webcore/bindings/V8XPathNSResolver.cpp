...
WrapperTypeInfo V8XPathNSResolver::info = { V8XPathNSResolver::GetTemplate, V8XPathNSResolver::derefObject, 0, 0 };
...
v8::Handle<v8::Object> V8XPathNSResolver::wrapSlow(XPathNSResolver* impl)
{
