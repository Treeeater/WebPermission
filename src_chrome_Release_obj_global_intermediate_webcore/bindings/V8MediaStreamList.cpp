...
WrapperTypeInfo V8MediaStreamList::info = { V8MediaStreamList::GetTemplate, V8MediaStreamList::derefObject, 0, 0 };

namespace MediaStreamListInternal {

template <typename T> void V8_USE(T) { }

static v8::Handle<v8::Value> lengthAttrGetter(v8::Local<v8::String> name, const v8::AccessorInfo& info)
{
    INC_STATS("DOM.MediaStreamList.length._get");
...
{
    INC_STATS("DOM.MediaStreamList.item");
    if (args.Length() < 1)
...
static const BatchedAttribute MediaStreamListAttrs[] = {
    // Attribute 'length' (Type: 'readonly attribute' ExtAttr: '')
    {"length", MediaStreamListInternal::lengthAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
};

static const BatchedCallback MediaStreamListCallbacks[] = {
    {"item", MediaStreamListInternal::itemCallback},
};
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8MediaStreamListTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "MediaStreamList", v8::Persistent<v8::FunctionTemplate>(), V8MediaStreamList::internalFieldCount,
        MediaStreamListAttrs, WTF_ARRAY_LENGTH(MediaStreamListAttrs),
        MediaStreamListCallbacks, WTF_ARRAY_LENGTH(MediaStreamListCallbacks));
...
v8::Handle<v8::Object> V8MediaStreamList::wrapSlow(MediaStreamList* impl)
{
