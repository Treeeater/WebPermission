...
WrapperTypeInfo V8SVGDefsElement::info = { V8SVGDefsElement::GetTemplate, V8SVGDefsElement::derefObject, 0, &V8SVGElement::info };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8SVGDefsElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "SVGDefsElement", V8SVGElement::GetTemplate(), V8SVGDefsElement::internalFieldCount,
        SVGDefsElementAttrs, WTF_ARRAY_LENGTH(SVGDefsElementAttrs),
        SVGDefsElementCallbacks, WTF_ARRAY_LENGTH(SVGDefsElementCallbacks));
...
v8::Handle<v8::Object> V8SVGDefsElement::wrapSlow(SVGDefsElement* impl)
{
