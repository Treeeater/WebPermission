...
WrapperTypeInfo V8DOMStringMap::info = { V8DOMStringMap::GetTemplate, V8DOMStringMap::derefObject, 0, 0 };
...
v8::Handle<v8::Object> V8DOMStringMap::wrapSlow(DOMStringMap* impl)
{
