...
WrapperTypeInfo V8SVGFEFloodElement::info = { V8SVGFEFloodElement::GetTemplate, V8SVGFEFloodElement::derefObject, 0, &V8SVGElement::info };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8SVGFEFloodElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "SVGFEFloodElement", V8SVGElement::GetTemplate(), V8SVGFEFloodElement::internalFieldCount,
        SVGFEFloodElementAttrs, WTF_ARRAY_LENGTH(SVGFEFloodElementAttrs),
        SVGFEFloodElementCallbacks, WTF_ARRAY_LENGTH(SVGFEFloodElementCallbacks));
...
v8::Handle<v8::Object> V8SVGFEFloodElement::wrapSlow(SVGFEFloodElement* impl)
{
