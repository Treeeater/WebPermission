...
WrapperTypeInfo V8CanvasPattern::info = { V8CanvasPattern::GetTemplate, V8CanvasPattern::derefObject, 0, 0 };
...
v8::Handle<v8::Object> V8CanvasPattern::wrapSlow(CanvasPattern* impl)
{
