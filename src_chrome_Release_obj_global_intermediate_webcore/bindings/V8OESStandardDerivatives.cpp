...
WrapperTypeInfo V8OESStandardDerivatives::info = { V8OESStandardDerivatives::GetTemplate, V8OESStandardDerivatives::derefObject, 0, 0 };

namespace OESStandardDerivativesInternal {

template <typename T> void V8_USE(T) { }

} // namespace OESStandardDerivativesInternal

static const BatchedConstant OESStandardDerivativesConsts[] = {
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8OESStandardDerivativesTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "OESStandardDerivatives", v8::Persistent<v8::FunctionTemplate>(), V8OESStandardDerivatives::internalFieldCount,
        0, 0,
        0, 0);
    ...
    batchConfigureConstants(desc, proto, OESStandardDerivativesConsts, WTF_ARRAY_LENGTH(OESStandardDerivativesConsts));
...
v8::Handle<v8::Object> V8OESStandardDerivatives::wrapSlow(OESStandardDerivatives* impl)
{
