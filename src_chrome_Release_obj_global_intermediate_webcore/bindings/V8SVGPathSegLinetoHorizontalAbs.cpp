...
WrapperTypeInfo V8SVGPathSegLinetoHorizontalAbs::info = { V8SVGPathSegLinetoHorizontalAbs::GetTemplate, V8SVGPathSegLinetoHorizontalAbs::derefObject, 0, &V8SVGPathSeg::info };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8SVGPathSegLinetoHorizontalAbsTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "SVGPathSegLinetoHorizontalAbs", V8SVGPathSeg::GetTemplate(), V8SVGPathSegLinetoHorizontalAbs::internalFieldCount,
        SVGPathSegLinetoHorizontalAbsAttrs, WTF_ARRAY_LENGTH(SVGPathSegLinetoHorizontalAbsAttrs),
        0, 0);
...
v8::Handle<v8::Object> V8SVGPathSegLinetoHorizontalAbs::wrapSlow(SVGPathSegLinetoHorizontalAbs* impl)
{
