...
WrapperTypeInfo V8SVGLengthList::info = { V8SVGLengthList::GetTemplate, V8SVGLengthList::derefObject, 0, 0 };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8SVGLengthListTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "SVGLengthList", v8::Persistent<v8::FunctionTemplate>(), V8SVGLengthList::internalFieldCount,
        SVGLengthListAttrs, WTF_ARRAY_LENGTH(SVGLengthListAttrs),
        SVGLengthListCallbacks, WTF_ARRAY_LENGTH(SVGLengthListCallbacks));
...
v8::Handle<v8::Object> V8SVGLengthList::wrapSlow(SVGListPropertyTearOff<SVGLengthList>* impl)
{
