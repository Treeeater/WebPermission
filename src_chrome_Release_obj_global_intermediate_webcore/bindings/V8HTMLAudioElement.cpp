...
WrapperTypeInfo V8HTMLAudioElement::info = { V8HTMLAudioElement::GetTemplate, V8HTMLAudioElement::derefObject, 0, &V8HTMLMediaElement::info };
...
v8::Handle<v8::Object> V8HTMLAudioElement::wrapSlow(HTMLAudioElement* impl)
{
