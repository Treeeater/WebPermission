...
WrapperTypeInfo V8HTMLTableColElement::info = { V8HTMLTableColElement::GetTemplate, V8HTMLTableColElement::derefObject, 0, &V8HTMLElement::info };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLTableColElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "HTMLTableColElement", V8HTMLElement::GetTemplate(), V8HTMLTableColElement::internalFieldCount,
        HTMLTableColElementAttrs, WTF_ARRAY_LENGTH(HTMLTableColElementAttrs),
        0, 0);
...
v8::Handle<v8::Object> V8HTMLTableColElement::wrapSlow(HTMLTableColElement* impl)
{
