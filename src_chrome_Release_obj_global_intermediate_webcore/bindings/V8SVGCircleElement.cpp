...
WrapperTypeInfo V8SVGCircleElement::info = { V8SVGCircleElement::GetTemplate, V8SVGCircleElement::derefObject, 0, &V8SVGElement::info };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8SVGCircleElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "SVGCircleElement", V8SVGElement::GetTemplate(), V8SVGCircleElement::internalFieldCount,
        SVGCircleElementAttrs, WTF_ARRAY_LENGTH(SVGCircleElementAttrs),
        SVGCircleElementCallbacks, WTF_ARRAY_LENGTH(SVGCircleElementCallbacks));
...
v8::Handle<v8::Object> V8SVGCircleElement::wrapSlow(SVGCircleElement* impl)
{
