...
WrapperTypeInfo V8DOMImplementation::info = { V8DOMImplementation::GetTemplate, V8DOMImplementation::derefObject, 0, 0 };
...
static v8::Handle<v8::Value> createDocumentTypeCallback(const v8::Arguments& args)
{
    ...
    ExceptionCode ec = 0;
    {
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<WithUndefinedOrNullCheck>, qualifiedName, MAYBE_MISSING_PARAMETER(args, 0, MissingIsUndefined));
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<WithUndefinedOrNullCheck>, publicId, MAYBE_MISSING_PARAMETER(args, 1, MissingIsUndefined));
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<WithUndefinedOrNullCheck>, systemId, MAYBE_MISSING_PARAMETER(args, 2, MissingIsUndefined));
...
static v8::Handle<v8::Value> createDocumentCallback(const v8::Arguments& args)
{
    ...
    EXCEPTION_BLOCK(DocumentType*, doctype, V8DocumentType::HasInstance(MAYBE_MISSING_PARAMETER(args, 2, MissingIsUndefined)) ? V8DocumentType::toNative(v8::Handle<v8::Object>::Cast(MAYBE_MISSING_PARAMETER(args, 2, MissingIsUndefined))) : 0);
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8DOMImplementationTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "DOMImplementation", v8::Persistent<v8::FunctionTemplate>(), V8DOMImplementation::internalFieldCount,
        0, 0,
        DOMImplementationCallbacks, WTF_ARRAY_LENGTH(DOMImplementationCallbacks));
...
v8::Handle<v8::Object> V8DOMImplementation::wrapSlow(DOMImplementation* impl)
{
