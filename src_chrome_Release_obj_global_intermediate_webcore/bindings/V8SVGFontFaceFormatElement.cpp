...
WrapperTypeInfo V8SVGFontFaceFormatElement::info = { V8SVGFontFaceFormatElement::GetTemplate, V8SVGFontFaceFormatElement::derefObject, 0, &V8SVGElement::info };
...
v8::Handle<v8::Object> V8SVGFontFaceFormatElement::wrapSlow(SVGFontFaceFormatElement* impl)
{
