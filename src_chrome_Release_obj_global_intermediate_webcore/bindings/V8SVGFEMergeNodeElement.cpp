...
WrapperTypeInfo V8SVGFEMergeNodeElement::info = { V8SVGFEMergeNodeElement::GetTemplate, V8SVGFEMergeNodeElement::derefObject, 0, &V8SVGElement::info };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8SVGFEMergeNodeElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "SVGFEMergeNodeElement", V8SVGElement::GetTemplate(), V8SVGFEMergeNodeElement::internalFieldCount,
        SVGFEMergeNodeElementAttrs, WTF_ARRAY_LENGTH(SVGFEMergeNodeElementAttrs),
        0, 0);
...
v8::Handle<v8::Object> V8SVGFEMergeNodeElement::wrapSlow(SVGFEMergeNodeElement* impl)
{
