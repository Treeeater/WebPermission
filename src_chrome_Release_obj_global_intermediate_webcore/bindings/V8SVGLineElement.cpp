...
WrapperTypeInfo V8SVGLineElement::info = { V8SVGLineElement::GetTemplate, V8SVGLineElement::derefObject, 0, &V8SVGElement::info };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8SVGLineElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "SVGLineElement", V8SVGElement::GetTemplate(), V8SVGLineElement::internalFieldCount,
        SVGLineElementAttrs, WTF_ARRAY_LENGTH(SVGLineElementAttrs),
        SVGLineElementCallbacks, WTF_ARRAY_LENGTH(SVGLineElementCallbacks));
...
v8::Handle<v8::Object> V8SVGLineElement::wrapSlow(SVGLineElement* impl)
{
