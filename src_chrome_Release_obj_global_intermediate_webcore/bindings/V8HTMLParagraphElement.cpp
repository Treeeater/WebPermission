...
WrapperTypeInfo V8HTMLParagraphElement::info = { V8HTMLParagraphElement::GetTemplate, V8HTMLParagraphElement::derefObject, 0, &V8HTMLElement::info };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLParagraphElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "HTMLParagraphElement", V8HTMLElement::GetTemplate(), V8HTMLParagraphElement::internalFieldCount,
        HTMLParagraphElementAttrs, WTF_ARRAY_LENGTH(HTMLParagraphElementAttrs),
        0, 0);
...
v8::Handle<v8::Object> V8HTMLParagraphElement::wrapSlow(HTMLParagraphElement* impl)
{
