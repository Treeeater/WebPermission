...
WrapperTypeInfo V8SVGPolygonElement::info = { V8SVGPolygonElement::GetTemplate, V8SVGPolygonElement::derefObject, 0, &V8SVGElement::info };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8SVGPolygonElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "SVGPolygonElement", V8SVGElement::GetTemplate(), V8SVGPolygonElement::internalFieldCount,
        SVGPolygonElementAttrs, WTF_ARRAY_LENGTH(SVGPolygonElementAttrs),
        SVGPolygonElementCallbacks, WTF_ARRAY_LENGTH(SVGPolygonElementCallbacks));
...
v8::Handle<v8::Object> V8SVGPolygonElement::wrapSlow(SVGPolygonElement* impl)
{
