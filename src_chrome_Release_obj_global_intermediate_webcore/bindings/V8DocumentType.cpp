...
WrapperTypeInfo V8DocumentType::info = { V8DocumentType::GetTemplate, V8DocumentType::derefObject, 0, &V8Node::info };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8DocumentTypeTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "DocumentType", V8Node::GetTemplate(), V8DocumentType::internalFieldCount,
        DocumentTypeAttrs, WTF_ARRAY_LENGTH(DocumentTypeAttrs),
        0, 0);
...
v8::Handle<v8::Object> V8DocumentType::wrapSlow(DocumentType* impl)
{
    ...
    if (impl->document()) {
        ...
        if (proxy && static_cast<Node*>(impl->document()) == static_cast<Node*>(impl)) {
            if (proxy->windowShell()->initContextIfNeeded()) {
                ...
                return V8DocumentType::wrap(impl);
            }
        }
    }
