...
WrapperTypeInfo V8MessageChannel::info = { V8MessageChannel::GetTemplate, V8MessageChannel::derefObject, 0, 0 };
...
v8::Handle<v8::Object> V8MessageChannel::wrapSlow(MessageChannel* impl)
{
