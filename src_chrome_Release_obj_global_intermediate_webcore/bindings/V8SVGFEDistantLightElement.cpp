...
WrapperTypeInfo V8SVGFEDistantLightElement::info = { V8SVGFEDistantLightElement::GetTemplate, V8SVGFEDistantLightElement::derefObject, 0, &V8SVGElement::info };
...
static v8::Handle<v8::Value> azimuthAttrGetter(v8::Local<v8::String> name, const v8::AccessorInfo& info)
{
    ...
    return toV8(imp->azimuthAnimated());
}
...
v8::Handle<v8::Object> V8SVGFEDistantLightElement::wrapSlow(SVGFEDistantLightElement* impl)
{
