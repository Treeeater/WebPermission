...
WrapperTypeInfo V8XMLSerializer::info = { V8XMLSerializer::GetTemplate, V8XMLSerializer::derefObject, 0, 0 };
...
v8::Handle<v8::Object> V8XMLSerializer::wrapSlow(XMLSerializer* impl)
{
