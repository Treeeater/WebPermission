...
WrapperTypeInfo V8SVGTSpanElement::info = { V8SVGTSpanElement::GetTemplate, V8SVGTSpanElement::derefObject, 0, &V8SVGTextPositioningElement::info };
...
v8::Handle<v8::Object> V8SVGTSpanElement::wrapSlow(SVGTSpanElement* impl)
{
