...
WrapperTypeInfo V8PageTransitionEvent::info = { V8PageTransitionEvent::GetTemplate, V8PageTransitionEvent::derefObject, 0, &V8Event::info };
...
{
    INC_STATS("DOM.PageTransitionEvent.Contructor");
    return V8Proxy::constructDOMObject<PageTransitionEvent>(args, &info);
}
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8PageTransitionEventTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "PageTransitionEvent", V8Event::GetTemplate(), V8PageTransitionEvent::internalFieldCount,
        PageTransitionEventAttrs, WTF_ARRAY_LENGTH(PageTransitionEventAttrs),
        PageTransitionEventCallbacks, WTF_ARRAY_LENGTH(PageTransitionEventCallbacks));
...
v8::Handle<v8::Object> V8PageTransitionEvent::wrapSlow(PageTransitionEvent* impl)
{
