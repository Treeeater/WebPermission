...
WrapperTypeInfo V8XMLHttpRequestUpload::info = { V8XMLHttpRequestUpload::GetTemplate, V8XMLHttpRequestUpload::derefObject, 0, 0 };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8XMLHttpRequestUploadTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "XMLHttpRequestUpload", v8::Persistent<v8::FunctionTemplate>(), V8XMLHttpRequestUpload::internalFieldCount,
        XMLHttpRequestUploadAttrs, WTF_ARRAY_LENGTH(XMLHttpRequestUploadAttrs),
        XMLHttpRequestUploadCallbacks, WTF_ARRAY_LENGTH(XMLHttpRequestUploadCallbacks));
...
v8::Handle<v8::Object> V8XMLHttpRequestUpload::wrapSlow(XMLHttpRequestUpload* impl)
{
