...
WrapperTypeInfo V8SVGPathSegMovetoAbs::info = { V8SVGPathSegMovetoAbs::GetTemplate, V8SVGPathSegMovetoAbs::derefObject, 0, &V8SVGPathSeg::info };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8SVGPathSegMovetoAbsTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "SVGPathSegMovetoAbs", V8SVGPathSeg::GetTemplate(), V8SVGPathSegMovetoAbs::internalFieldCount,
        SVGPathSegMovetoAbsAttrs, WTF_ARRAY_LENGTH(SVGPathSegMovetoAbsAttrs),
        0, 0);
...
v8::Handle<v8::Object> V8SVGPathSegMovetoAbs::wrapSlow(SVGPathSegMovetoAbs* impl)
{
