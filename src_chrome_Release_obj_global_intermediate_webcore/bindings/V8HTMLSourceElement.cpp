...
WrapperTypeInfo V8HTMLSourceElement::info = { V8HTMLSourceElement::GetTemplate, V8HTMLSourceElement::derefObject, 0, &V8HTMLElement::info };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLSourceElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "HTMLSourceElement", V8HTMLElement::GetTemplate(), V8HTMLSourceElement::internalFieldCount,
        HTMLSourceElementAttrs, WTF_ARRAY_LENGTH(HTMLSourceElementAttrs),
        0, 0);
...
v8::Handle<v8::Object> V8HTMLSourceElement::wrapSlow(HTMLSourceElement* impl)
{
