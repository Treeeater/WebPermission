...
WrapperTypeInfo V8SQLException::info = { V8SQLException::GetTemplate, V8SQLException::derefObject, 0, 0 };
...
v8::Handle<v8::Object> V8SQLException::wrapSlow(SQLException* impl)
{
