...
WrapperTypeInfo V8SharedWorkerContext::info = { V8SharedWorkerContext::GetTemplate, V8SharedWorkerContext::derefObject, 0, &V8WorkerContext::info };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8SharedWorkerContextTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "SharedWorkerContext", V8WorkerContext::GetTemplate(), V8SharedWorkerContext::internalFieldCount,
        SharedWorkerContextAttrs, WTF_ARRAY_LENGTH(SharedWorkerContextAttrs),
        0, 0);
...
v8::Handle<v8::Object> V8SharedWorkerContext::wrapSlow(SharedWorkerContext* impl)
{
