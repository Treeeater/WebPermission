...
WrapperTypeInfo V8CSSCharsetRule::info = { V8CSSCharsetRule::GetTemplate, V8CSSCharsetRule::derefObject, 0, &V8CSSRule::info };
...
v8::Handle<v8::Object> V8CSSCharsetRule::wrapSlow(CSSCharsetRule* impl)
{
