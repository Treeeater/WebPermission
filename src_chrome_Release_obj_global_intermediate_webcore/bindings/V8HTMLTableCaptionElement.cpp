...
WrapperTypeInfo V8HTMLTableCaptionElement::info = { V8HTMLTableCaptionElement::GetTemplate, V8HTMLTableCaptionElement::derefObject, 0, &V8HTMLElement::info };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLTableCaptionElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "HTMLTableCaptionElement", V8HTMLElement::GetTemplate(), V8HTMLTableCaptionElement::internalFieldCount,
        HTMLTableCaptionElementAttrs, WTF_ARRAY_LENGTH(HTMLTableCaptionElementAttrs),
        0, 0);
...
v8::Handle<v8::Object> V8HTMLTableCaptionElement::wrapSlow(HTMLTableCaptionElement* impl)
{
    ...
    if (impl->document()) {
        ...
        if (proxy && static_cast<Node*>(impl->document()) == static_cast<Node*>(impl)) {
            if (proxy->windowShell()->initContextIfNeeded()) {
                ...
                return V8HTMLTableCaptionElement::wrap(impl);
            }
        }
    }
