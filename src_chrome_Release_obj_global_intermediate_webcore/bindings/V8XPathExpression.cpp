...
WrapperTypeInfo V8XPathExpression::info = { V8XPathExpression::GetTemplate, V8XPathExpression::derefObject, 0, 0 };
...
static v8::Handle<v8::Value> evaluateCallback(const v8::Arguments& args)
{
    ...
    ExceptionCode ec = 0;
    {
    EXCEPTION_BLOCK(Node*, contextNode, V8Node::HasInstance(MAYBE_MISSING_PARAMETER(args, 0, MissingIsUndefined)) ? V8Node::toNative(v8::Handle<v8::Object>::Cast(MAYBE_MISSING_PARAMETER(args, 0, MissingIsUndefined))) : 0);
    EXCEPTION_BLOCK(int, type, toUInt32(MAYBE_MISSING_PARAMETER(args, 1, MissingIsUndefined)));
    EXCEPTION_BLOCK(XPathResult*, inResult, V8XPathResult::HasInstance(MAYBE_MISSING_PARAMETER(args, 2, MissingIsUndefined)) ? V8XPathResult::toNative(v8::Handle<v8::Object>::Cast(MAYBE_MISSING_PARAMETER(args, 2, MissingIsUndefined))) : 0);
...
v8::Handle<v8::Object> V8XPathExpression::wrapSlow(XPathExpression* impl)
{
